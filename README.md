...
<h1 style="font-weight:700; font-size:42px; margin-bottom:0; 
background: linear-gradient(90deg, #0047FF, #00C2FF);
-webkit-background-clip: text; 
color: transparent;">
College Admission Analysis — R Project
</h1>

<p style="font-size:18px; margin-top:6px; color:#7c8aa5;">
Statistical Modeling • Prediction • Insight Extraction
</p>

<hr style="width:60%; border: none; height:2px; 
background: linear-gradient(90deg, #0047FF, #00C2FF, #0047FF); 
border-radius: 4px;" />

<p style="font-size:15px; line-height:1.5; color:#6e7a92; max-width:650px;">
A refined, data-driven exploration of college admissions.  
From transforming messy datasets to building interpretable predictive models,  
this project turns statistical rigor into meaningful, human-centered insights.
</p>
